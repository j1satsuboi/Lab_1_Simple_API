...
app.get('/equation?:equation', (req, res) => {  // Уравнение
    ...
    if(a == undefined || b == undefined || c == undefined) {
        res.send('Пожалуйста, вводите запрос через переменные a, b и c')
    }
        ...
        res.send('Пожалуйста, вводите целые числа')
    }
})

app.get('/date?:date', (req, res) => {  // Дата
...
app.use('/fibonacci', fibonacciRouter)  // Фибоначчи

app.use('/region', regionRouter)        // Регион
